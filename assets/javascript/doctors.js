$(".selections").on("click", "#submitBtn", function() {
    ...
    var queryURL = "https://api.betterdoctor.com/2016-03-01/doctors?specialty_uid=pediatrician&location=" + state + "-" + loc + "&skip=0&limit=50&user_key=986d188fa4063779e75e3bcfd20f0956";
